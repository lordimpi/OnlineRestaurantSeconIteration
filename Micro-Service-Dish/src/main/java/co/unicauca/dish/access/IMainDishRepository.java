...
public interface IMainDishRepository {
    ...
    /**
     * Declaacion del metodo buscar plato por Id para ser utilizado por la API
     * REST
     *
    ...
    /**
     * Declaracion del metodo crear plato principal para ser utilizado por la
     * API REST
     *
    ...
    /**
     * Declaracion del metodo actualizar plato principal para ser utilizado por
     * la API REST
     *
    ...
    /**
     * Declaracion del metodo borrar plato principal para ser utilizado por la
     * API REST
     *
