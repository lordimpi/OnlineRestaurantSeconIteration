...
import co.unicauca.dish.domain.service.SaladService;
...
public class SaladController {
    ...
    /*
        ...
        curl -X GET http://localhost:8085/Micro-Service-Dish/dish-service/salads/ 
     */
    @GET
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X GET http://localhost:8085/Micro-Service-Dish/dish-service/salads/1 
     */
    @GET
    @Path("{id}")
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X POST \
          http://localhost:8085/Micro-Service-Dish/dish-service/maindishes/ \
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X PUT \
          http://localhost:8085/Micro-Service-Dish/dish-service/salads/20 \
          -H 'Content-Type: application/json' \
          -d '{
               "name":"frutos rojos",
               "price":2400
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X DELETE http://localhost:8085/Micro-Service-Dish/dish-service/salads/20 
     */
    @DELETE
    @Path("{id}")
