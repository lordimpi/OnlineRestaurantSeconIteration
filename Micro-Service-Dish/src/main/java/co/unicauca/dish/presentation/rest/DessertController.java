...
public class DessertController {
    ...
    /*
        ...
        curl -X GET http://localhost:8085/Micro-Service-Dish/dish-service/desserts/ 
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X GET http://localhost:8085/Micro-Service-Dish/dish-service/desserts/1 
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X POST \
          http://localhost:8085/Micro-Service-Dish/dish-service/desserts/ \
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X PUT \
          http://localhost:8085/Micro-Service-Dish/dish-service/desserts/1 \
          -H 'Content-Type: application/json' \
          -d '{
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X DELETE http://localhost:8085/Micro-Service-Dish/dish-service/desserts/1 
