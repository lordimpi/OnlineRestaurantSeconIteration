...
public class MainDishController {
    ...
    /*
        ...
        curl -X GET http://localhost:8085/Micro-Service-Dish/dish-service/maindishes/ 
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X GET http://localhost:8085/Micro-Service-Dish/dish-service/maindishes/1 
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X PUT \
          http://localhost:8085/Micro-Service-Dish/dish-service/maindishes/103 \
          -H 'Content-Type: application/json' \
          -d '{
               "name":"caldo de huevo",
               "price":2400
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X DELETE http://localhost:8085/Micro-Service-Dish/dish-service/maindishes/103 
