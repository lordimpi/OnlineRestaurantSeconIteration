 ...
 */
public class GUIModifyUser extends javax.swing.JFrame {

    /**
     * Guarda el email como nombre de usuario para poder modificar
     */
    private String userName;
    /**
     * Guarda el rol ya sea admin o user para ser modificado
     */
     ...
     */
    public GUIModifyUser() {
        initComponents();
        if (GUIMenuAdmin.getUser() != null) {
            userRol = GUIMenuAdmin.getUser().getRol();
            userName = GUIMenuAdmin.getUser().getEmail();
        }
        if(GUIMenuCustomer.getUser() != null){
            userRol = GUIMenuCustomer.getUser().getRol();
            userName = GUIMenuCustomer.getUser().getEmail();
        }
     ...
     * @param evt Evento del boton modificar usuario
     */
        ...
        if (jTxfEmail.getText().contains("@")) {
            try {
                if (service.updateUser(userName, user)) {
                    Messages.successMessage("Usuario modificado con exito", "Exito");
                    userName = user.getEmail();
                    userRol = user.getRol();
                } else {
                    Messages.warningMessage("ERROR: No se pudo modificar el usuario", "Error");
                }
            } catch (Exception ex) {
                Logger.getLogger(GUIModifyUser.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    /**
     * Cancela la accion de modificar usuario y limpia los campos
     * @param evt 
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIModifyUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIModifyUser().setVisible(true);
            }
        });
    }
