...
public class GUIDeleteDishEntry extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTblPlatoEntrada = new javax.swing.JTable();

        setClosable(true);
        setMaximizable(true);
        setResizable(true);
        setTitle("Borrar Plato de entrada");
        setToolTipText("");
        ...
        jTblPlatoEntrada.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jTblPlatoEntrada.setFocusable(false);
        jTblPlatoEntrada.setRowHeight(30);
        jTblPlatoEntrada.getTableHeader().setReorderingAllowed(false);
        jTblPlatoEntrada.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTblPlatoEntradaMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTblPlatoEntrada);
    ...
    /**
     * Boton encargado de eliminar plato de entrada
     *
     * @param evt evento del boton
     */
    private void jBtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEliminarActionPerformed
        ...
        Messages.successMessage("El plato de Entrada " + id + " fue elimado", "EXITO");
        cargarLista();
        mostrarTabla();
     ...
     */
    private void jTblPlatoEntradaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTblPlatoEntradaMouseClicked

        int i = jTblPlatoEntrada.getSelectedRow();
        TableModel model = jTblPlatoEntrada.getModel();
        this.jTxfID.setText(model.getValueAt(i, 0).toString());
    }//GEN-LAST:event_jTblPlatoEntradaMouseClicked
    ...
    private javax.swing.JTable jTblPlatoEntrada;
    ...
    private void cargarLista() {
        ...
        try {
            platosEntrada = entryservice.listEntrys();
        } catch (Exception ex) {
            successMessage(ex.getMessage(), "Atención");
        }
    }
    ...
    private void mostrarTabla() {
        String dataTable[][] = new String[platosEntrada.size()][3];

        for (int i = 0; i < platosEntrada.size(); i++) {
            dataTable[i][0] = platosEntrada.get(i).getIdDishEntry();
            dataTable[i][1] = platosEntrada.get(i).getNameDishEntry();
            dataTable[i][2] = Double.toString(platosEntrada.get(i).getCostDishEntry());
        }
