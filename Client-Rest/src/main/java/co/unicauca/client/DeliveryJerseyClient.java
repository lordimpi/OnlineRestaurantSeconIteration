...
public class DeliveryJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8085/Micro-Service-Delivery/delivery-service";
    ...
    public <T> List<Delivery> findAll(GenericType<List<Delivery>> responseType) throws javax.ws.rs.ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
