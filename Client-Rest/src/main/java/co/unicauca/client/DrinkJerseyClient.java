...
/**
 * Jersey REST client generated for REST resource:DrinkController [/drinks]<br>
 * USAGE:
 * <pre>
 *        DrinkJerseyClient client = new DrinkJerseyClient();
 ...
 * @author Personal
 */
public class DrinkJerseyClient {
    ...
    public DrinkJerseyClient() {
        ...
        webTarget = client.target(BASE_URI).path("drinks");
    }
    ...
    public <T> List<Drink> findAll(GenericType<List<Drink>> responseType) throws javax.ws.rs.ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
