...
import co.unicauca.onlinerestaurant.domain.service.DrinkService;
...
public class DrinkController {
    ...
    /*
        ...
        curl -X GET http://localhost:8085/OnlineRestaurant-Service/restaurant-service/drinks/ 
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X GET http://localhost:8085/OnlineRestaurant-Service/restaurant-service/drinks/1 
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X POST \
          http://localhost:8085/OnlineRestaurant-Service/restaurant-service/drinks/ \
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X PUT \
          http://localhost:8085/OnlineRestaurant-Service/restaurant-service/drinks/1 \
          -H 'Content-Type: application/json' \
          -d '{
    ...
    /*
        Su uso desde consola mediante client url:
        curl -X DELETE http://localhost:8085/Product-Service/product-service/drinks/1 
